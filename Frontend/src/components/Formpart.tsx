...
import type { FormData1 ,FormField } from "./DynamicForm";
                    ...
                    return (
                      <Box key={index} sx={{ mt: 2 }}>
                        ...
                        <TextField
                          ...
                          label="Enter your options seperated by comma"
                        />
                      ...
                      <Box key={index} sx={{ mt: 2 }}>
                        ...
                        <Button variant="contained" component="label">
                          ...
                          <input
                            ...
                            hidden
                            onChange={() =>
                              handleChange(field.id, "value", null)
                            }
                          />
                        </Button>
                        <IconButton
